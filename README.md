...
MVP acadêmico de loja virtual em PHP e MySQL.

## Uso local

1. Inicie Apache e MySQL no XAMPP.
2. Importe `MM.sql` no phpMyAdmin.
3. Acesse a pasta pelo Apache.

## Acessos

- Administração: `admin@magicmerch.local` / `MagicMerch123!`
- Clientes podem criar uma conta na página de acesso.
